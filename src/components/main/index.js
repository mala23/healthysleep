...
const Main = (props) => (
  <main>
    <Section 
      ...
      body="Bei Müdigkeitserscheinungen greift man als erstes gerne zu einem Kaffee. Das Koffein darin verspricht uns wach zu werden. Koffein ist eigentlich ein Nervengift, es soll die Pflanzen vor Schädlingen schützen.<br>Koffein zögert unsere Müdigkeit hinaus. Es ist in der Struktur  ähnlich wie Adenosin. Dieses hat im Hypothalamus die Funktion Nervenzellen zu hemmen, wenn es an A1 Adenosinrezeptoren andockt.  Wenn Koffein andockt, gibt es keinen direkten Effekt, aber das Adenosin kann nicht mehr andocken und somit nicht hemmen.<br>Koffein hat noch andere wachmachende Effekte in unserem Körper, indem es den Stoffwechsel, Herzschlag, Puls und auch die Atmung angeregt."
